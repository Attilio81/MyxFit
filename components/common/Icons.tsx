...
export const DumbbellIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 8.25v-1.5a2.25 2.25 0 00-4.5 0v1.5m4.5 0V15M6.75 12H4.5a2.25 2.25 0 00-2.25 2.25v.75m17.5-3H17.25a2.25 2.25 0 00-2.25 2.25v.75m0 0V15m0-2.25H12.75m0 0V8.25" />
...
export const TrophyIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a9.75 9.75 0 1011.64-9.032A9.75 9.75 0 007.5 3.75m11.25 15.064V15.75a1.5 1.5 0 00-1.5-1.5h-3.75a1.5 1.5 0 00-1.5 1.5v3.014m5.25 0a1.5 1.5 0 001.5-1.5v-3.014a1.5 1.5 0 00-1.5-1.5h-3.75a1.5 1.5 0 00-1.5 1.5v3.014m0 0a1.5 1.5 0 001.5 1.5h.008a1.5 1.5 0 001.492-1.5v-.014m-3.75 0a1.5 1.5 0 001.5 1.5h.008a1.5 1.5 0 001.492-1.5v-.014m-3.75 0a1.5 1.5 0 001.5 1.5h.008a1.5 1.5 0 001.492-1.5v-.014m-3.75 0h3.75" />
    </svg>
);
...
// FIX: Add missing ChatBubbleOvalLeftEllipsisIcon component.
